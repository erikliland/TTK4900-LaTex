...
\begin{table}
	\begin{tabularx}{\textwidth}{ |X|X| }
	  ...
	  Height over keel &  \\
	  \bottomrule
	\end{tabularx}~\label{tab:static-ais}\caption{Static AIS information}
	...
	\begin{tabularx}{\textwidth}{ |X|X| }
	  ...
	  Rate of turn (ROT) & \\
	  \bottomrule
	\end{tabularx}~\label{tab:dynamic-ais}\caption{Dynamic AIS information}
	...
	\begin{tabularx}{\textwidth}{ |X|X| }
	  ...
	  \bottomrule
	\end{tabularx}~\label{tab:vyage-ais}\caption{Voyage AIS information}
