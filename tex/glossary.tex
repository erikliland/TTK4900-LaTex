...
{
	name 		= NMEA,
	description = {Communication protocol used between electronic maritime equipment}
}
...
\newglossaryentry{track hypothesis}
{
	...
	description = {A leaf node with its predecessors. A set of estimated states over time of one target.}
}
